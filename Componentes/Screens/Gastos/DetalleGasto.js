...
export default function DetalleGasto({ navigation }) {
  ...
  const handleEdit = () => {
    const IdGasto = item.Id;
    //const IdCategoria = 0;
    navigation.navigate("RegistroGasto", { IdGasto });
  };
  ...
  const handleDelete = () => {
    ...
    setMensajeConfirmacion(`Desea eliminar el gasto con ID ${id_del}?`);
  ...
  const eliminarRegistro = async () => {
    ...
    setReady(false)
    setTituloespera("Eliminando Gasto..")

    const endpoint = `ref/OperacionesGastosUser/${id_del}/`;
    const metodo = "DELETE";
          ...
          >
            ...
            >
              ...
              <View style={{ alignItems: "center" }}>
                ...
                >
                  {registroPrincipal.CantidadConceptoGasto ?? 0}
                </Text>
              </View>
              ...
              <View style={{ alignItems: "flex-end" }}>
                ...
                >
                  Gs.{" "}
                  {Number(
                    registroPrincipal.TotalConceptoGasto
            ...
            <View style={[styles.observacionContainer,{borderTopColor: colors.screen_componente_estilos.color_fondo}]}>
                ...
                >
                  ...
                  >
                    {registroPrincipal.NombreCategoria || "Sin observación"}
                  </Text>
                </View>
            </View>
            <View style={[styles.observacionContainer,{borderTopColor: colors.screen_componente_estilos.color_fondo}]}>
                ...
                >
                  ...
                  >
                    {registroPrincipal.NombreTipoGasto || "Sin observación"}
                  </Text>
                </View>
            </View>
